---
title: Version 1.6.1
description: ApkPy 1.6.1 targets API 35 so Google Play accepts the builds, draws every screen around the system bars, and paints the background a label asks for.
---
