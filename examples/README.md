...
| [`29_nfc_tags.py`](29_nfc_tags.py) | NFC status, foreground reading, one-shot text/URL writes, cancellation, settings and error recovery; simulated tags on desktop |
